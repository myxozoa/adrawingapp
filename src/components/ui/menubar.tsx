...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn("flex h-8 items-center space-x-1 rounded-sm border bg-background p-1", className)}
    {...props}
  />
))
